...
module.exports = function (arg, options) {
  ...
  var fn = function (config) {
    ...
    function configureApp() {
      ...
      var setAddonsPlugins = addonsPlugins(plugins).configure(config.addons);
      var setAddons = addons(app).configure(config.addons, plugins).then(setAddonsPlugins);
      ...
      return Promise.all([setConfigVars, setAddons, setCollaborators, setFormation, setLogDrains, setDomains]);
    }
