...
module.exports = function (arg) {
  ...
  var fn = function (config) {
    ...
    function configureApp(result) {
      ...
      // addons
      var createOrUpdateAddons = addons(app).createOrUpdate(config.addons);
      ...
      return Promise.all(updateConfigVars.concat(createOrUpdateAddons, updateCollaborators, updateAppFeatures, updateFormation, updateLogDrains));
    }
